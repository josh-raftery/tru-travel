...
export default function Previous({ fill = "black" }) {
    ...
    const handlePrevious = () => {
        navigate(-1) // This is equivalent to window.history.back() but works with React Router
    }
